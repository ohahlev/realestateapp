...
class T_VIEW_EXPORT partial_banner-bottomView : public TActionView
{
  Q_OBJECT
public:
  partial_banner-bottomView() : TActionView() { }
  QString toString();
};

QString partial_banner-bottomView::toString()
{
...
T_DEFINE_VIEW(partial_banner-bottomView)

#include "partial_banner-bottomView.moc"
