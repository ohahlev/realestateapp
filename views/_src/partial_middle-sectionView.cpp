...
class T_VIEW_EXPORT partial_middle-sectionView : public TActionView
{
  Q_OBJECT
public:
  partial_middle-sectionView() : TActionView() { }
  QString toString();
};

QString partial_middle-sectionView::toString()
{
...
T_DEFINE_VIEW(partial_middle-sectionView)

#include "partial_middle-sectionView.moc"
