...
class T_VIEW_EXPORT partial_searchView : public TActionView
{
  Q_OBJECT
public:
  partial_searchView() : TActionView() { }
  QString toString();
};

QString partial_searchView::toString()
{
  responsebody.reserve(1903);
...
T_DEFINE_VIEW(partial_searchView)

#include "partial_searchView.moc"
